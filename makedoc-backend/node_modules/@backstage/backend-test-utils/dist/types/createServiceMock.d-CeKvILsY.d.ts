 ...
 * @public
 */
declare function createServiceMock<TService>(ref: ServiceRef<TService, any>, mockFactory: () => jest.Mocked<TService>): (partialImpl?: Partial<TService>) => ServiceMock<TService>;

export { createServiceMock as c };
export type { ServiceMock as S };
