...
var createServiceMock = require('./createServiceMock.cjs.js');
...
((mockServices2) => {
  ...
  ((rootConfig2) => {
    ...
    rootConfig2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.rootConfig, () => ({
      get: jest.fn(),
      getBoolean: jest.fn(),
      getConfig: jest.fn(),
  ...
  ((rootLogger2) => {
    ...
    rootLogger2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.rootLogger, () => ({
      child: jest.fn(),
      debug: jest.fn(),
      error: jest.fn(),
      info: jest.fn(),
  ...
  ((auditor2) => {
    ...
    auditor2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.auditor, () => ({
  ...
  ((auth2) => {
    ...
    auth2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.auth, () => ({
  ...
  ((discovery2) => {
    ...
    discovery2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.discovery, () => ({
      getBaseUrl: jest.fn(),
  ...
  ((httpAuth2) => {
    ...
    httpAuth2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.httpAuth, () => ({
      credentials: jest.fn(),
  ...
  ((userInfo2) => {
    ...
    userInfo2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.userInfo, () => ({
      getUserInfo: jest.fn()
    }));
  })(userInfo = mockServices2.userInfo || (mockServices2.userInfo = {}));
  ((cache2) => {
    cache2.factory = () => cache.cacheServiceFactory;
    cache2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.cache, () => ({
      delete: jest.fn(),
      get: jest.fn(),
      set: jest.fn(),
      withOptions: jest.fn()
  ...
  ((database2) => {
    ...
    database2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.database, () => ({
      getClient: jest.fn()
    }));
  })(database$1 = mockServices2.database || (mockServices2.database = {}));
  ((rootHealth2) => {
    rootHealth2.factory = () => rootHealth.rootHealthServiceFactory;
    rootHealth2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.rootHealth, () => ({
      getLiveness: jest.fn(),
  ...
  ((httpRouter2) => {
    ...
    httpRouter2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.httpRouter, () => ({
      use: jest.fn(),
  ...
  ((rootHttpRouter2) => {
    ...
    rootHttpRouter2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.rootHttpRouter, () => ({
      use: jest.fn()
    }));
  })(mockServices2.rootHttpRouter || (mockServices2.rootHttpRouter = {}));
  ((lifecycle2) => {
    lifecycle2.factory = () => lifecycle.lifecycleServiceFactory;
    lifecycle2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.lifecycle, () => ({
  ...
  ((logger2) => {
    ...
    logger2.mock = createServiceMock.createServiceMock(
  ...
  ((permissions2) => {
    ...
    permissions2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.permissions, () => ({
      authorize: jest.fn(),
  ...
  ((permissionsRegistry2) => {
    ...
    permissionsRegistry2.mock = createServiceMock.createServiceMock(
      backendPluginApi.coreServices.permissionsRegistry,
      () => ({
  ...
  ((rootLifecycle2) => {
    ...
    rootLifecycle2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.rootLifecycle, () => ({
      addShutdownHook: jest.fn(),
  ...
  ((scheduler2) => {
    ...
    scheduler2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.scheduler, () => ({
  ...
  ((urlReader2) => {
    ...
    urlReader2.mock = createServiceMock.createServiceMock(backendPluginApi.coreServices.urlReader, () => ({
      readTree: jest.fn(),
      readUrl: jest.fn(),
      search: jest.fn()
    }));
  ...
  ((events2) => {
    ...
    events2.mock = createServiceMock.createServiceMock(pluginEventsNode.eventsServiceRef, () => ({
      publish: jest.fn(),
      subscribe: jest.fn()
    }));
  ...
  ((rootInstanceMetadata2) => {
    rootInstanceMetadata2.mock = createServiceMock.createServiceMock(
