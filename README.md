...
The MakeDoc page must also be added to the Developer Hub sidebar so that users can access it from the left-hand navigation.

Add the following `SidebarItem`:
...
This adds **MakeDoc** to the left-hand sidebar and links it to the `/makedoc-plugin` route.
